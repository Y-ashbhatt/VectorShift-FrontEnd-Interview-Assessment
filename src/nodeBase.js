...
const NodeBase = ({
  ...
  return (
    <div
      className={`${nodeWidth} p-4 bg-white rounded-lg shadow-md border border-secondary transition-transform transform hover:scale-105 ${customClassName}`}
    >
      <div className="text-lg font-bold mb-2" style={{ color: "#420d8b" }}>
        {title}
      </div>
      <div className="mb-3">
